    ...
    <>
      <div>
        ...
        <input
          ...
          step={
            properties["interval"] ? properties["interval"].toString() : null
          }
          ...
          pattern={
            properties["validationRegex"] ? properties["validationRegex"] : null
          }
          style={
            properties["style"]
              ? properties["style"]
          ...
          {error ? (
            <p
              ...
              {properties["errorMessage"]
                ? properties["errorMessage"]
                : properties.type in regexObject
                ? regexObject[properties.type]["errorMessage"]
                : null}
            </p>
          ) : null}
        </div>
